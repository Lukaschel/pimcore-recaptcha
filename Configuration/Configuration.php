...
namespace Lukaschel\PimcoreRecaptchaBundle\Configuration;
...
class Configuration
{
    const SYSTEM_CONFIG_DIR_PATH = PIMCORE_PRIVATE_VAR . '/bundles/PimcoreRecaptchaBundle';
    const SYSTEM_CONFIG_FILE_PATH = PIMCORE_PRIVATE_VAR . '/bundles/PimcoreRecaptchaBundle/config.yml';
